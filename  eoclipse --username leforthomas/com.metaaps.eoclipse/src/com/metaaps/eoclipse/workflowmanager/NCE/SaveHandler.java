...
public class SaveHandler extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if(obj instanceof WorkFlow)
        {
    		...
    		dialog.setFileName(workflow.getLabel());
    		dialog.open();
			try {
				FileOutputStream fileoutputstream = new FileOutputStream(dialog.getFilterPath() + "/" + dialog.getFileName());
				workflow.writeToStream(fileoutputstream);
